...
public class Wode_AccountsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wode__accounts);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_accounts);
        toolbar.setTitle("");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent_set = new Intent(Wode_AccountsActivity.this, Wode_SettingActivity.class);
                finish();
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (verification(phone_reg, phone))
                            ...
                            Toast.makeText(Wode_AccountsActivity.this, "请输入有效的手机号", Toast.LENGTH_SHORT).show();
                    }
                })
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (verification(email_reg, email)) {
                            ...
                            Toast.makeText(Wode_AccountsActivity.this, "请输入合法的邮箱", Toast.LENGTH_SHORT).show();
                    }
                })
                .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!verification(password_reg, password)) {
                            Toast.makeText(Wode_AccountsActivity.this, "请输入合法的密码，" +
                                    "密码的强度必须是包含大小写字母和数字的组合，" +
                                    "不能使用特殊字符，长度在8-10之间", Toast.LENGTH_SHORT).show();
                        } else if (!(password_confirm.equals(password))) {
                            Toast.makeText(Wode_AccountsActivity.this, "密码不一致", Toast.LENGTH_SHORT).show();
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (verification(qq_reg, qq))
                            ...
                            Toast.makeText(Wode_AccountsActivity.this, "请输入合法的qq", Toast.LENGTH_SHORT).show();
                    }
                })
                .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (verification(wechat_reg, wechat))
                            ...
                            Toast.makeText(Wode_AccountsActivity.this, "请输入合法的wechat,微信账号仅支持6-20个字母、数字、下划线或减号，以字母开头", Toast.LENGTH_SHORT).show();
                    }
                })
                .setNegativeButton("取消", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
